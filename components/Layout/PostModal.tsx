...
import { Comment, Post } from "@/types/app.types";
...
export function PostModal({
  ...
  const { user, users, updatePost } = useAppData();
  ...
  const postUser = users.find((u) => u.id === currentPost.userId);
  ...
  const handleComment = (e: React.FormEvent) => {
    ...
    const currentComments = currentPost.commentsList || [];
